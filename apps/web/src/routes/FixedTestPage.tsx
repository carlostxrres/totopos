...
import { FixedTestSubmitPanel } from "@/components/FixedTestSubmitPanel";
  ...
  return (
    <div className="py-4">
      ...
      <div className="space-y-4 mt-4">
        ...
        <FixedTestSubmitPanel
          test={fixedTest}
          answeredCount={answeredCount}
          unansweredCount={unansweredCount}
          flaggedUnansweredCount={flaggedUnansweredCount}
          flaggedAnsweredCount={flaggedAnsweredCount}
